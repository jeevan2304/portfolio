          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Uttambg/ticket-app" target="_blank" rel="noreferrer">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/Uttambg/WordPedia" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>WordPedia -</h3>
              <p>
              This dictionary app leverages Dagger Hilt for robust dependency injection and adopts the MVVM architectural pattern to ensure clean separation of concerns and enhanced testability. Built with Jetpack Compose, the app provides detailed information including phonetics, definitions, and usage examples for searched words..
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Uttambg/VReality-TextEditor" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://vercel.com/api/toolbar/link/v-reality-text-editor.vercel.app?via=project-dashboard-alias-list&p=1&page=/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>VReality - Text Editor to create VR apps</h3>
              <p>
              Designed and developed a landing page for a client’s text editor tailored for creating VR applications. The page featured clear pricing options for Enterprise, Community, and Free versions, emphasizing the product’s versatility and accessibility. The design focused on intuitive navigation, engaging visuals, and effective messaging to drive conversions and capture the target audience’s interest.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Uttambg/My_PdfApp" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>MyPdf -PDF management app</h3>
              <p>A PDF management app leveraging Firebase Realtime Database for seamless uploading, storage, and retrieval, enabling users to both view and download PDFs within the application interface.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Kotlin</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Uttambg/MusicApp_UI" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>Musico - A music playing app</h3>
              <p>Music UI app built with MVVM architecture and Jetpack Compose for composable UI, featuring account management, user profiles, library, search, and home sections.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>OpenCV</li>
